 ...
 */
package com.hollly.example.offical.counter.rpc;
...
import com.hollly.example.offical.counter.CounterClosure;
import com.hollly.example.offical.counter.CounterService;
 ...
 */
public class IncrementAndGetRequestProcessor implements RpcRequestProcessor<IncrementAndGetRequest> {
    ...
    @Override
    public void handleRequest(final RpcAsyncContext rpcCtx, final IncrementAndGetRequest request) {
