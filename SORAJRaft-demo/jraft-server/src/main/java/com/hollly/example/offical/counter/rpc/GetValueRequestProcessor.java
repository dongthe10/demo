 ...
 */
public class GetValueRequestProcessor implements RpcServer<GetValueRequest> {
    ...
    @Override
    public void handleRequest(final RpcAsyncContext rpcCtx, final GetValueRequest request) {
